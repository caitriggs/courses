...
if __name__ == '__main__':
    ...
    path = '/home/ubuntu/courses/deeplearning1/nbs/data/lesson_2_HW_Kaggle/'

    #Load data
    train, train_bands = read_jason(file='train.json', loc=path)
    test, test_bands = read_jason(file='test.json', loc=path)
    ...
    print('splitted: {0}, {1}'.format(x1.shape, x2.shape))
    ...
    file = 'statoil_subm_{}_xgb.csv'.format(tmp)
