...
#from keras.regularizers import l2, activity_l2, l1, activity_l1 #older keras version
from keras.regularizers import l2, l1
from keras.layers.normalization import BatchNormalization
from keras.optimizers import SGD, RMSprop, Adam
#from keras.utils.layer_utils import layer_from_config #older keras version
...
def get_data(path, target_size=(224,224)):
    ...
    return np.concatenate([batches.next() for i in range(batches.samples)]) # old --> batches.nb_sample
