...
from keras.layers.convolutional import Conv2D, MaxPooling2D, ZeroPadding2D # Conv2D for new 2.1.2 keras
...
class Vgg16():
    ...
    def ConvBlock(self, layers, filters):
        ...
        for i in range(layers):
            ...
            # model.add(Convolution2D(filters, 3, 3, activation='relu')) # old keras
            model.add(Conv2D(filters, 3, 3, activation='relu')) # new 2.1.2 keras
